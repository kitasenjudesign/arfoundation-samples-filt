...
namespace NatCorder.Internal {
    ...
    public static class MediaRecorderBridge {
        ...
        public static extern IntPtr CreateHEVCRecorder (int width, int height, int framerate, int bitrate, int keyframeInterval, int sampleRate, int channelCount);
        ...
        public static IntPtr CreateHEVCRecorder (int width, int height, int framerate, int bitrate, int keyframeInterval, int sampleRate, int channelCount) { return IntPtr.Zero; }
